...
import finalkursproject.dao.IClientDao;
...
public class ClientDao implements IClientDao {
    ...
    private static final String UNBAN_CLIENT = "UPDATE rielt_estate.client SET rielt_estate.client.ban = 0 WHERE rielt_estate.client.user_iduser = ?";
    private static final String ADD_POINTS = "UPDATE rielt_estate.client SET rielt_estate.client.point = ? WHERE rielt_estate.client.user_iduser = ?";
    private static final String BAN_CLIENT = "UPDATE rielt_estate.client SET rielt_estate.client.ban = 1 WHERE rielt_estate.client.user_iduser = ?";
    private static final String EDIT_CLIENT = "UPDATE rielt_estate.client SET rielt_estate.client.surname = ?,rielt_estate.client.name = ?,rielt_estate.client.email = ? WHERE rielt_estate.client.user_iduser = ?";
    ...
    private static final String CHANGE_PASSWORD = "UPDATE rielt_estate.user SET rielt_estate.user.password = ? WHERE rielt_estate.user.iduser = ?";
    ...
    @Override
    public Client addClient(int idUser, String login, String name, String surname, String email) throws
            DaoException {
    ...
    public User findUserByLogin(String login) throws DaoException {
        ...
        try {
            ...
            try {
                ...
                if (resultSet.first()) {
                    user = new User();
                    user.setIdUser(resultSet.getInt("user.iduser"));
    ...
    @Override
    public Client editClient(int idClient, String surname, String name, String email) throws
            DaoException {
