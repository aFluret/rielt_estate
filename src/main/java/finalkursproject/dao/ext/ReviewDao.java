...
import finalkursproject.dao.IReviewDao;
...
public class ReviewDao implements IReviewDao {
    private static final String ADD_REVIEW = "INSERT INTO rielt_estate.review (review_text,mark,client_user_iduser) VALUES (?,?,?)";
    private static final String FIND_ALL_REVIEWS = "SELECT * FROM rielt_estate.review";
