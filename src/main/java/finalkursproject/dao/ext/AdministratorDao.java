...
import finalkursproject.dao.IAdministratorDao;
...
public class AdministratorDao implements IAdministratorDao {
    ...
    private static final String ADD_USER = "INSERT INTO rielt_estate.user (login,password,role) VALUES (?,?,?)";
    private static final String ADD_ADMIN = "INSERT INTO rielt_estate.admin (user_iduser,is_main) VALUES (?,?)";
