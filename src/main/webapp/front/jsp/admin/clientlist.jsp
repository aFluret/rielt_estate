                    ...
                    <div>
                        <div style="outline: 2px solid #000000">
                            <div class="text-center">
                                <form action="/rielt-torg.by/ban_client?idClient=${client.idUser}" method="post">
                                    ...
                                    <div >
                                        ...
                                        <div class="post-meta">
                                            ...
                                            <c:choose>
                                                <c:when test="${client.ban eq 'false'}">
                                                    <button type="submit"
                                                            class="btn btn-warning">${ban_client}</button>
                                                </c:when>
                                                <c:otherwise>
                                                    <button type="submit"
                                                            class="btn btn-success">${unban_client}</button>
                                                </c:otherwise>
                                            </c:choose>
                                        </div>
