...
<jsp:useBean class="finalkursproject.entity.Administrator" scope="page" id="adminuser"/>
...
<div class="registration-container">
    <c:choose>
        <c:when test="${admin.main eq 'true'}">
            <button type="button" class="add-admin-button" class="btn btn-default" id="addadmin">${add_admin_word}</button>
        </c:when>
    </c:choose>
                    ...
                    <c:if test="${adminuser.idUser!=admin.idUser}">
                        ...
                        <div>
                            <div style="outline: 2px solid #000000">
                                <div class="clearfix">
                                    <form action="/rielt-torg.by/delete_admin?idAdmin=${adminuser.idUser}" method="post">
