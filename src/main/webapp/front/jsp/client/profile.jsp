...
<fmt:message bundle="${loc}" key="local.sentence.account_status" var="account_status"/>
...
<head>
    ...
    <style>
        ...
        <%@include file="/front/css/service.css" %>
                ...
                <div class="row" >
                    ...
                    <div class="col-md-6">
                        <form id="profile-form" class="form-horizontal form-horizontal-profile" method="post"
                              action="/rielt-torg.by/edit_profile">

                            <span class="heading">${your_profile}</span>

                            <div class="form-group">
                                <span class="profile-span">${login}</span>
                                <input type="text" class="form-control has-bregistration" id="profile-login"
                                       value="${client.login}" disabled="disabled" name="login_profile">
                            </div>

                            <div class="form-group">
                                <span class="profile-span">${surname}</span>
                                <input type="text" class="form-control has-bregistration" id="profile-surname"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control has-bregistration" id="profile-name"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control has-bregistration" id="profile-email"
                            ...
                            <div id="flex-btn">
                                <c:if test="${account==null}">
                                    <button type="button" class="btn btn-default"
                                            id="addaccount">${add_account_btn}</button>
                                </c:if>
                                <button type="button" class="btn btn-default"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <form id="account-form" class="form-horizontal form-horizontal-profile" method="post"
                                      action="/rielt-torg.by/delete_account?idAccount=${account.idAccount}">

                                    <span class="heading">${your_account}</span>

                                    <div class="form-group">
                                        <span class="profile-span">${account_number}</span>
                                        <input type="text" class="form-control has-bregistration" id="account-number"
                                               value="${account.accountNumber}" disabled="disabled"
                                               name="login_profile">
                                    </div>

                                    <div class="form-group">
                                        <span class="profile-span">${account_status}</span>
                                        <input type="text" class="form-control has-bregistration" id="account-account_status"
                                               value="${account.accountStatus}" disabled="disabled" name="login_profile">
                                    </div>
                                    <div>

                                        <button type="submit" class="btn btn-default"
                                                id="change"    style=" margin-right: 40px;">${delete_account_word}</button>
                                    </div>
